...
hist(model_data_ab$RescaledAbundance) ; hist(model_data_ab$logRescaledAbundance) ; hist(model_data_ab$logAbundance) ; hist(model_data_ab$sqrtRescaledAbundance)

plot(density(model_data_ab$logRescaledAbundance)) ; plot(density(model_data_ab$logAbundance)) 
