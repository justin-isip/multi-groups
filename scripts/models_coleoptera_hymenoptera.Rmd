...
# Have a look at the signif icance of the terms
Anova(hym_ab2) 

# Use_intensity:Within_hymenoptera is nthe least significant interaction in the model so we can remove this term 
...
result <- ggpredict(hym_ab2.1, c("LogAbundance", "Within_hymenoptera"))
