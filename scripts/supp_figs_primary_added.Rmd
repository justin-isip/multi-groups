...
ggsave("./figures/supp_figures/col_hym.png", col_hym, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/dip_hym.png", dip_hym, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/hemi_hym.png", hemi_hym, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/hym_lep.png", hym_lep, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/col_dip.png", col_dip, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/col_hemi.png", col_hemi, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/col_lep.png", col_lep, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/dip_hemi.png", dip_hemi, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/dip_lep.png", dip_lep, height = 9, width = 9)
```
...
ggsave("./figures/supp_figures/hemi_lep.png", hemi_lep, height = 9, width = 9)
```
