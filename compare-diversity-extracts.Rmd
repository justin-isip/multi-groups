...
updated_diversity <- readRDS("./data/diversity-2023-08-21-02-33-23.rds")
```
...
updated <- correct_for_sampling_effort(updated_diversity)

print(summarise_diversity(diversity)) ; print(summarise_diversity(updated_diversity))
...
```{r}
  ...
  data <- as.data.frame(updated_diversity) 
