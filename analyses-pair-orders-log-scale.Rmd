...
# This Rmd is for replotting the pairwise comparisons on the log abudance scale (i.e. the fitted values rather than the % change in abundance or species richness), this is important as the log plots are closer to the models and it will be easier to discern if something weird is going on.
...
# Plot template for log abundance
```{r}
...
# Combine effects
combine <- rbind(dip_eff, hym_eff)

# Plot effects on the log abundance scale 

ggarrange(diptera_hymenoptera_plot_AB, diptera_hymenoptera_plot_AB_primary, nrow = 2, common.legend =  TRUE, legend = "bottom") 
...
dip <- corr_dip_hym[1:8,1]
hym <- corr_dip_hym[9:nrow(corr_dip_hym), 1]
...
rm(dhy_m2, dhy_m4, dhy_m5, dhy_m6, dhy_m7, hym_1, hym_eff, diptera_hymenoptera, dip_eff, corr_dip_hym, diptera, hymenoptera, combine)
...
col_eff <- predict_this_model(dc_m2, order = "Coleoptera", baseline = "median")
...
dip_eff <- predict_this_model(dip_m2, order = "Diptera", baseline = "median")

# Combine effects
combine <- rbind(dip_eff, col_eff)

# Relevel so Diptera appears first
combine <- combine %>% mutate(Order = relevel(Order, ref = "Diptera"))

# Plot the effects for both orders
diptera_coleoptera_plot_AB <- 
    combine %>%
  ggplot()+
        aes(x = Predominant_land_use, y = median, colour = Order, group = Order)+
        geom_hline(yintercept = 0, linewidth = 0.5, color = ("black"), linetype = 1)+
...
rm(col_eff, corr, dc_m2, dc_m4, dc_m5, dc_m6, dc_m7, dip_eff, dip_m2, coleoptera, diptera, diptera_coleoptera, combine)
...
```{r}
# Predict Diptera effects 
dip_eff <- predict_this_model(dh_m1, order = "Diptera", baseline = "median")
...
hemi_eff <- predict_this_model(hemi_m1, order = "Hemiptera", baseline = "median")

# Combine effects
combine <- rbind(dip_eff, hemi_eff)
...
rm(corr, dh_m1, dh_m4, dh_m5, dh_m6, dh_m7, dip_eff, diptera_hemiptera, hemi_eff, hemi_m1, diptera, hemiptera, combine)
...
```{r}
# Predict Diptera effects 
dip_eff <- predict_this_model(dl_m2, order = "Diptera", baseline = "median")
...
lep_eff <- predict_this_model(lep_m1, order = "Lepidoptera", baseline = "median")

# Combine effects
combine <- rbind(dip_eff, lep_eff)
...
rm(col_eff, corr, dl_m2, dl_m4, dl_m5, dl_m6, dl_m7, lep_eff, dip_eff, lep_m1, lepidoptera, diptera, diptera_lepidoptera, combine)
```
...
```{r}
# Predict Coleoptera effects 
col_eff <- predict_this_model(hc_m2, order = "Coleoptera", baseline = "median")
...
# Combine effects
combine <- rbind(col_eff, hym_eff)

# Plot the effects for both orders
coleoptera_hymenoptera_plot_AB <- 
    combine %>%
  ggplot()+
        aes(x = Predominant_land_use, y = median, colour = Order, group = Order)+
        geom_hline(yintercept = 0, linewidth = 0.5, color = ("black"), linetype = 1)+
...
```{r}
# Predict Hemiptera effects 
hem_eff <- predict_this_model(hh_m1, order = "Hemiptera", baseline = "median")
...
# Combine effects
combine <- rbind(hem_eff, hym_eff)

# Plot the effects for both orders
hymenoptera_hemiptera_plot_AB <- 
    combine %>%
  ggplot()+
        aes(x = Predominant_land_use, y = median, colour = Order, group = Order)+
        geom_hline(yintercept = 0, linewidth = 0.5, color = ("black"), linetype = 1)+
...
rm(hem_eff, corr, hh_m1, hh_m4, hh_m5, hh_m6, hh_m7, hym_eff, hym_m1, hemiptera, hymenoptera, hymenoptera_hemiptera, combine)
```
...
```{r}
# Predict Hymenoptera effects 
hym_eff <- predict_this_model(hl_m2, order = "Hymenoptera", baseline = "median")
...
rm(hym_eff, corr, hl_m2, hl_m4, hl_m5, hl_m6, hl_m7, lep_eff, lep_m1, hymenoptera, lepidoptera, hymenoptera_lepidoptera, combine)
```
...
```{r}
# Predict Hemiptera effects 
hem_eff <- predict_this_model(hl_m1, order = "Hemiptera", baseline = "median")
...
rm(hem_eff, corr, hl_m1, hl_m4, hl_m5, hl_m6, hl_m7, lep_eff, lep_m1, hemiptera, lepidoptera, hemiptera_lepidoptera, combine)
```
...
```{r}
# Predict Coleoptera effects 
col_eff <- predict_this_model(hc_m1, order = "Coleoptera", baseline = "median")
...
# Predict Hemiptera effects 
hem_eff <- predict_this_model(hem_m1, order = "Hemiptera", baseline = "median")

# Combine effects
combine <- rbind(col_eff, hem_eff)

# Plot the effects for both orders
hemiptera_coleoptera_plot_AB <- 
    combine %>%
  ggplot()+
        aes(x = Predominant_land_use, y = median, colour = Order, group = Order)+
        geom_hline(yintercept = 0, linewidth = 0.5, color = ("black"), linetype = 1)+
...
rm(col_eff, corr, hc_m1, hc_m4, hc_m5, hc_m6, hc_m7, hem_eff, hem_m1, coleoptera, hemiptera, hemiptera_coleoptera, combine)
```
...
```{r}
# Predict Coleoptera effects 
col_eff <- predict_this_model(cl_m1, order = "Coleoptera", baseline = "median")
...
rm(col_eff, corr, cl_m1, cl_m4, cl_m5, cl_m6, cl_m7, lep_eff, lep_m1, coleoptera, lepidoptera, coleoptera_lepidoptera,combine)
```
...
# Check the distributions
hist(model_data_sr$SpeciesRichness) ; hist(model_data_sr$logSR) ; hist(log10(model_data_sr$SpeciesRichness)) 
...
# Its the same sets of studies for abundance and richness (richness is calculated from ab) so I don't need to recalculate the studies for species richness data
...
rm(dip_eff, corr, dhy_m2, dhy_m4, dhy_m5, dhy_m6, dhy_m7, hym_eff, hym_m1, hymenoptera, diptera, diptera_hymenoptera, combine)
```
...
# dc_m7 (null intercept only) has lower AIC than dc_m2 but doesn't matter as we are only interested in the interaction
```
### Simulate diptera_coleoptera effects
```{r}
# Predict Coleoptera effects 
...
# Predict Diptera effects - remember that this overwrites previous effects of Diptera model
dip_eff <- predict_this_model(dip_m1, order = "Diptera", baseline = "median")

# Combine effects
combine <- rbind(col_eff, dip_eff)

# Relevel so Diptera appears first
combine <- combine %>% mutate(Order = relevel(Order, ref = "Diptera"))

# Plot the effects for both orders
diptera_coleoptera_plot_SR <- 
    combine %>%
  ggplot()+
        aes(x = Predominant_land_use, y = median, colour = Order, group = Order)+
        geom_hline(yintercept = 0, linewidth = 0.5, color = ("black"), linetype = 1)+
...
rm(col_eff, corr, dc_m2, dc_m4, dc_m5, dc_m6, dc_m7, dip_eff, dip_m1, col, dip, diptera_coleoptera, combine)
```
...
```{r}
# Predict Diptera effects 
dip_eff <- predict_this_model(dh_m3, order = "Diptera", baseline = "median")
...
rm(hemi_eff, corr, dh_m3, dh_m4, dh_m5, dh_m6, dh_m7, dip_eff, hemi_m1, dip, hemi, diptera_hemiptera, combine)
```
...
```{r}
# Predict Diptera effects 
dip_eff <- predict_this_model(dl_m3, order = "Diptera", baseline = "median")
...
rm(dip_eff, corr, dl_m3, dl_m4, dl_m5, dl_m6, dl_m7, lep_eff, lep_m1, dip, lep, diptera_lepidoptera, combine)
```
...
rm(col_eff, corr, hc_m2, hc_m4, hc_m5, hc_m6, hc_m7, hym_eff, hym_m1, col, hym, hymenoptera_coleoptera, combine)
```
...
```{r}
# Predict Hemiptera effects 
hem_eff <- predict_this_model(hh_m2, order = "Hemiptera", baseline = "median")
...
rm(hem_eff, corr, hh_m2, hh_m4, hh_m5, hh_m6, hh_m7, hym_eff, hym_m1, hemi, hym, hymenoptera_hemiptera, combine)
```
...
rm(hym_eff, corr, hl_m2, hl_m4, hl_m5, hl_m6, hl_m7, lep_eff, lep_m1, hym, lep, hymenoptera_lepidoptera, combine)
```
...
```{r}
# Predict Hemiptera effects 
hem_eff <- predict_this_model(hl_m3, order = "Hemiptera", baseline = "median")
...
rm(hem_eff, corr, hl_m3, hl_m4, hl_m5, hl_m6, hl_m7, lep_eff, lep_m1, hemi, lep, hemiptera_lepidoptera, combine)
```
...
rm(col_eff, corr, hc_m1, hc_m4, hc_m5, hc_m6, hc_m7, hem_eff, hem_m1, col, hemi, hemiptera_coleoptera, combine)
```
...
```{r}
# Predict Coleoptera effects 
col_eff <- predict_this_model(cl_m2, order = "Coleoptera", baseline = "median")
...
rm(col_eff, corr, cl_m2, cl_m4, cl_m5, cl_m6, cl_m7, lep_eff, lep_m1, col, lep, coleoptera_lepidoptera,combine)
```
...
ggsave("./figures/log_figures/hym_lep.png", hym_lep, height = 7, width = 7)    

hym_hemi <- ggarrange(hymenoptera_hemiptera_plot_AB, hymenoptera_hemiptera_plot_SR, nrow = 2, common.legend =  TRUE, legend = "bottom") 
ggsave("./figures/log_figures/hym_hemi.png", hym_hemi, height = 7, width = 7)    

hym_col <- ggarrange(coleoptera_hymenoptera_plot_AB, hymenoptera_coleoptera_plot_SR, nrow = 2, common.legend =  TRUE, legend = "bottom") 
ggsave("./figures/log_figures/hym_col.png", hym_col, height = 7, width = 7)    

hemi_lep <- ggarrange(hemiptera_lepidoptera_plot_AB, hemiptera_lepidoptera_plot_SR, nrow = 2, common.legend =  TRUE, legend = "bottom") 
ggsave("./figures/log_figures/hemi_lep.png", hemi_lep, height = 7, width = 7)  

hemi_col <- ggarrange(hemiptera_coleoptera_plot_AB, hemiptera_coleoptera_plot_SR, nrow = 2, common.legend =  TRUE, legend = "bottom") 
ggsave("./figures/log_figures/hemi_col.png", hemi_col, height = 7, width = 7)    

col_lep <- ggarrange(coleoptera_lepidoptera_plot_AB, coleoptera_lepidoptera_plot_SR, nrow = 2, common.legend =  TRUE, legend = "bottom") 
ggsave("./figures/log_figures/col_lep.png", col_lep, height = 7, width = 7)  
```
